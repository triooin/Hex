...
public class VaultRepository {
    public static final String FILENAME = "hex.json";
    public static final String FILENAME_PREFIX_EXPORT = "hex-export";
    public static final String FILENAME_PREFIX_EXPORT_PLAIN = "hex-export-plain";
    public static final String FILENAME_PREFIX_EXPORT_URI = "hex-export-uri";
    public static final String FILENAME_PREFIX_EXPORT_HTML = "hex-export-html";
