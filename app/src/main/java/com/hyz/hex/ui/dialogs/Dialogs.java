...
import com.hyz.hex.BackupsVersioningStrategy;
import com.hyz.hex.Preferences;
import com.hyz.hex.R;
import com.hyz.hex.helpers.EditTextHelper;
import com.hyz.hex.helpers.PasswordStrengthHelper;
import com.hyz.hex.helpers.SimpleTextWatcher;
import com.hyz.hex.importers.DatabaseImporter;
import com.hyz.hex.ui.tasks.KeyDerivationTask;
import com.hyz.hex.vault.VaultEntry;
import com.hyz.hex.vault.slots.PasswordSlot;
import com.hyz.hex.vault.slots.Slot;
import com.hyz.hex.vault.slots.SlotException;
...
public class Dialogs {
    ...
    public static void showDeleteEntriesDialog(Context context, List<VaultEntry> services, DialogInterface.OnClickListener onDelete) {
        ...
        showSecureDialog(new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Hex_AlertDialog_Warning)
                .setTitle(title)
                .setView(view)
    ...
    public static void showErrorDialog(Context context, String message, CharSequence error, DialogInterface.OnClickListener listener) {
        ...
        AlertDialog dialog = new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Hex_AlertDialog_Error)
    ...
    public static void showMultiErrorDialog(
        ...
        Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Hex_AlertDialog_Error)
                .setTitle(title)
                .setMessage(message)
                .setCancelable(false)
                .setIconAttribute(android.R.attr.alertDialogIcon)
    ...
    public static void showPartialGoogleAuthImportWarningDialog(Context context, List<Integer> missingIndexes, int entries, List<CharSequence> scanningErrors, DialogInterface.OnClickListener dismissHandler) {
        ...
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Hex_AlertDialog_Warning)
