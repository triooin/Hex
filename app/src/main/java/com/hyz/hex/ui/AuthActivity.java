...
import com.hyz.hex.crypto.KeyStoreHandle;
import com.hyz.hex.crypto.KeyStoreHandleException;
import com.hyz.hex.crypto.MasterKey;
import com.hyz.hex.helpers.BiometricsHelper;
import com.hyz.hex.helpers.EditTextHelper;
import com.hyz.hex.helpers.MetricsHelper;
import com.hyz.hex.helpers.UiThreadExecutor;
import com.hyz.hex.ui.dialogs.Dialogs;
import com.hyz.hex.ui.tasks.PasswordSlotDecryptTask;
...
import com.hyz.hex.vault.slots.SlotIntegrityException;
...
public class AuthActivity extends HexActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        biometricsButton.setOnClickListener(v -> {
            if (_prefs.isPasswordReminderNeeded()) {
                Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_Hex_AlertDialog_Warning)
    ...
    private void onInvalidPassword() {
        Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(AuthActivity.this, R.style.ThemeOverlay_Hex_AlertDialog_Error)
