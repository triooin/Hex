...
import com.hyz.hex.PassReminderFreq;
...
import com.hyz.hex.helpers.BiometricSlotInitializer;
import com.hyz.hex.helpers.BiometricsHelper;
import com.hyz.hex.ui.dialogs.Dialogs;
import com.hyz.hex.ui.preferences.SwitchPreference;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        _encryptionPreference.setOnPreferenceChangeListener((preference, newValue) -> {
            if (!_vaultManager.getVault().isEncryptionEnabled()) {
                ...
                Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_Hex_AlertDialog_Warning)
        ...
        _pinKeyboardPreference.setOnPreferenceChangeListener((preference, newValue) -> {
            ...
            Dialogs.showPasswordInputDialog(requireContext(), R.string.set_password_confirm, R.string.pin_keyboard_description, password -> {
                if (isDigitsOnly(new String(password))) {
                    ...
                    Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_Hex_AlertDialog_Error)
