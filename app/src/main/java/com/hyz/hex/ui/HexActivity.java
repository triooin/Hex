...
import com.hyz.hex.ThemeMap;
import com.hyz.hex.database.AuditLogRepository;
import com.hyz.hex.helpers.ThemeHelper;
...
@AndroidEntryPoint
public abstract class HexActivity extends AppCompatActivity implements VaultManager.LockListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set FLAG_SECURE on the window of every HexActivity
