...
import com.hyz.hex.GroupPlaceholderType;
import com.hyz.hex.Preferences;
import com.hyz.hex.R;
import com.hyz.hex.SortCategory;
import com.hyz.hex.helpers.BitmapHelper;
import com.hyz.hex.helpers.DropdownHelper;
import com.hyz.hex.helpers.FabScrollHelper;
import com.hyz.hex.helpers.PermissionHelper;
import com.hyz.hex.helpers.ViewHelper;
import com.hyz.hex.icons.IconType;
import com.hyz.hex.otp.GoogleAuthInfo;
import com.hyz.hex.otp.GoogleAuthInfoException;
import com.hyz.hex.otp.OtpInfoException;
import com.hyz.hex.ui.dialogs.Dialogs;
import com.hyz.hex.ui.fragments.preferences.BackupsPreferencesFragment;
import com.hyz.hex.ui.fragments.preferences.PreferencesFragment;
import com.hyz.hex.ui.models.ErrorCardInfo;
import com.hyz.hex.ui.models.VaultGroupModel;
import com.hyz.hex.ui.tasks.IconOptimizationTask;
import com.hyz.hex.ui.tasks.QrDecodeTask;
import com.hyz.hex.ui.views.EntryListView;
import com.hyz.hex.util.TimeUtils;
import com.hyz.hex.util.UUIDMap;
import com.hyz.hex.vault.VaultEntry;
import com.hyz.hex.vault.VaultEntryIcon;
...
public class MainActivity extends HexActivity implements EntryListView.Listener {
   ...
   private void updateErrorCard() {
       ...
       if (backupRes != null) {
           ...
           info = new ErrorCardInfo(text, view -> {
               Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_Hex_AlertDialog_Error)
    ...
    private void showPlaintextExportWarningOptions() {
        ...
        AlertDialog dialog = new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_Hex_AlertDialog_Warning)
