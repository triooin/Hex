...
import com.hyz.hex.helpers.ContextHelper;
...
import com.hyz.hex.vault.VaultEntryException;
...
public class HexImporter extends DatabaseImporter {

    public HexImporter(Context context) {
        super(context);
    }
    ...
    public static class EncryptedState extends State {
        ...
        public void decrypt(Context context, DecryptListener listener) {
            Dialogs.showPasswordInputDialog(context, R.string.enter_password_hex_title, 0, (Dialogs.TextInputListener) password -> {
                List<PasswordSlot> slots = getSlots().findAll(PasswordSlot.class);
