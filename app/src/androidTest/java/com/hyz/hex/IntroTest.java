...
import com.hyz.hex.ui.IntroActivity;
...
@HiltAndroidTest
@LargeTest
public class IntroTest extends HexTest {
    ...
    public void testIntro_Import_Plain() {
        assertFalse(_prefs.isIntroDone());
        Uri uri = getResourceUri("hex_plain.json");
    ...
    public void testIntro_Import_Encrypted() {
        assertFalse(_prefs.isIntroDone());
        Uri uri = getResourceUri("hex_encrypted.json");
        Intent resultData = new Intent();
        resultData.setData(uri);
