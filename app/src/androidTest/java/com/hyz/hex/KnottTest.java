...
import com.hyz.hex.crypto.SCryptParameters;
import com.hyz.hex.otp.OtpInfo;
import com.hyz.hex.ui.views.EntryHolder;
...
public abstract class HexTest {
    ...
    protected HexApplicationBase getApp() {
        return (HexApplicationBase) InstrumentationRegistry.getInstrumentation().getTargetContext().getApplicationContext();
    }
