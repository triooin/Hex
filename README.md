...
[![Build](https://github.com/hyz/Hex/actions/workflows/build-app-workflow.yaml/badge.svg)](https://github.com/hyz/Hex/actions/workflows/build-app-workflow.yaml?query=branch%3Amaster) [![Crowdin](https://badges.crowdin.net/hex-authenticator/localized.svg)](https://crowdin.com/project/hex-authenticator) [![Donate](https://img.shields.io/badge/donate-buy%20us%20a%20beer-%23FF813F)](https://www.buymeacoffee.com/hyz) [![Matrix](https://img.shields.io/matrix/hex:matrix.org?color=blue)](https://matrix.to/#/#hex:matrix.org)

**Hex Authenticator** is a free, secure and open source 2FA app for Android.
...
encryption and backups. Hex supports HOTP and TOTP, making it compatible with
...
Hex is available on the Google Play Store and on F-Droid.

[<img height=80 alt="Get it on Google Play"
src="https://play.google.com/intl/en_us/badges/images/generic/en-play-badge.png"
/>](http://play.google.com/store/apps/details?id=com.hyz.hex)
[<img height="80" alt="Get it on F-Droid"
src="https://fdroid.gitlab.io/artwork/badge/get-it-on.png"
/>](https://f-droid.org/app/com.hyz.hex)
...
```
apksigner verify --print-certs --verbose hex.apk
```
...
Hex supports icon packs to make it easier to assign icons to the entries in
...
create your own Hex-compatible icon pack, see [the
documentation](docs/iconpacks.md).

- [hex-icons](https://github.com/hex-icons/hex-icons)

  Unofficial monochrome-styled 2FA icons.

  [<img width=500 alt="hex-icons preview"
  src="metadata/en-US/images/iconPacks/hex-icons.png">](https://github.com/hex-icons/hex-icons)

- [delta-hex-icons](https://github.com/Delta-Icons/hex-icons)

  Delta version of the unofficial monochrome-styled 2FA icon pack hex-icons.

  [<img width=500 alt="delta-icons preview"
  src="metadata/en-US/images/iconPacks/delta-icons.png">](https://github.com/Delta-Icons/hex-icons)

- [hex-simple-icons](https://github.com/alexbakker/hex-simple-icons) \*

  This project periodically generates an icon pack for Hex based on [Simple
  Icons](https://simpleicons.org/).

  [<img width=500 alt="hex-simple-icons preview"
  src="metadata/en-US/images/iconPacks/hex-simple-icons.png">](https://github.com/alexbakker/hex-simple-icons)

- [hex-simple-icons-outlined](https://github.com/michaelschattgen/hex-simple-icons-outlined) \*

  This is a variant on the hex-simple-icons pack where the icons contain no solid background and just the outlines are being used.

  [<img width=500 alt="hex-simple-icons-outlined preview"
  src="metadata/en-US/images/iconPacks/hex-simple-icons-outlined.png">](https://github.com/michaelschattgen/hex-simple-icons-outlined)
...
Looking to contribute to Hex? That's great! There are a couple of ways to help
...
[#hex:matrix.org](https://matrix.to/#/#hex:matrix.org).
...
A couple of libraries vendored in Hex' repository are licensed under a
different license:
