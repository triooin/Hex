...
# example usage: ./scripts/decrypt.py --input ./app/src/test/resources/com/hyz/hex/importers/hex_encrypted.json
# password: test
...
def main():
    parser = argparse.ArgumentParser(description="Decrypt an Hex vault")
    parser.add_argument("--input", dest="input", required=True, help="encrypted Hex vault file")
    parser.add_argument("--output", dest="output", default="-", help="output file ('-' for stdout)")
    args = parser.parse_args()

    # parse the Hex vault file
